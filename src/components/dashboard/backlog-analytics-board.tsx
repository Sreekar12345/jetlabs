...
const INITIAL_STUDENTS: Student[] = [
  ...
  },
  {
    ...
    roll: "21CSE022",
    dept: "Computer Science",
    scores: [0, 0, 1, 0, 2, 0, 0, 0],
    active: 2,
    cleared: 1,
    severity: "Moderate",
    clearedSems: { 5: true }, // S5 Database Systems is cleared, Operating Systems is pending
  },
  {
    name: "Sneha Iyer",
    roll: "21AIML031",
    ...
    cleared: 1,
    severity: "Stable",
    clearedSems: { 5: true }, // S5 Probability & Statistics is cleared
  },
  {
    name: "Karan Singh",
    roll: "21ECE044",
  ...
  },
  {
    ...
    cleared: 1,
    severity: "Stable",
    clearedSems: { 7: true }, // S7 Compiler Design is cleared
  },
  {
    name: "Tanvi Desai",
    roll: "21AIML042",
...
// Static Chart Data matching Mockups
const semesterWiseData = [
  { name: "Sem 1", active: 0, cleared: 0 },
  { name: "Sem 2", active: 0, cleared: 0 },
  { name: "Sem 3", active: 2, cleared: 0 },
  { name: "Sem 4", active: 0, cleared: 0 },
  { name: "Sem 5", active: 5, cleared: 2 },
  { name: "Sem 6", active: 3, cleared: 0 },
  { name: "Sem 7", active: 0, cleared: 1 },
  { name: "Sem 8", active: 0, cleared: 0 },
];

const yearWiseData = [
  { name: "Y1", active: 0, cleared: 0 },
  { name: "Y2", active: 2, cleared: 0 },
  { name: "Y3", active: 8, cleared: 2 },
  { name: "Y4", active: 0, cleared: 1 },
];

const failureTrendData = [
  { name: "Y1 S1", active: 0, cleared: 0 },
  { name: "Y1 S2", active: 0, cleared: 0 },
  { name: "Y2 S3", active: 2, cleared: 0 },
  { name: "Y2 S4", active: 0, cleared: 0 },
  { name: "Y3 S5", active: 5, cleared: 2 },
  { name: "Y3 S6", active: 3, cleared: 0 },
  { name: "Y4 S7", active: 0, cleared: 1 },
  { name: "Y4 S8", active: 0, cleared: 0 },
];

const failedSubjectsData = [
  { code: "CS305", name: "Operating Systems", count: 2 },
  { code: "MA204", name: "Discrete Mathematics", count: 1 },
  { code: "EC301", name: "Signals & Systems", count: 1 },
  { code: "MA301", name: "Engineering Math III", count: 1 },
  { code: "CS404", name: "Computer Networks", count: 1 },
  { code: "CS403", name: "Theory of Computation", count: 1 },
  { code: "CS402", name: "Software Engineering", count: 1 },
  { code: "AI301", name: "Machine Learning", count: 1 },
];

const clearanceTrendsData = [
  { month: "Jul '25", cleared: 3 },
  { month: "Aug '25", cleared: 3 },
  { month: "Sep '25", cleared: 4 },
  { month: "Oct '25", cleared: 4 },
  { month: "Nov '25", cleared: 4 },
  { month: "Dec '25", cleared: 2 },
  { month: "Jan '26", cleared: 0 },
  { month: "Feb '26", cleared: 0 },
  { month: "Mar '26", cleared: 1 },
  { month: "Apr '26", cleared: 1 },
];
