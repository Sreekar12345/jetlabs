  ...
  if (REQUIRE_VERIFICATION_BEFORE_ACCESS && user?.verificationStatus !== "VERIFIED") {
    return (
      <PageContainer
        ...
        description="Structure prior art and reference materials"
      >
            ...
            <CardContent className="flex flex-col items-center justify-center p-8 text-center space-y-5">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-slate-500 leading-relaxed">
                  Access to research workflows is locked until your student profile is verified by your advisor. Please check your profile status and update any incorrect details.
                </p>
              </div>
              <Link
