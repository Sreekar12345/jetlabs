  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Sparkles,
        description: "AI-assisted rapid triage for approvals, revisions, and escalations.",
        section: "Review",
      },
    ],
  },
    ...
    items: [
      {
        ...
        },
        {
          ...
          icon: Activity,
          description: "Responsibility distribution, dependency risk, and collaboration intelligence.",
          section: "Monitoring",
        },
      {
